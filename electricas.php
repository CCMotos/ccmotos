...
$marcas = [];
$sqlMarcas = "SELECT DISTINCT marca FROM moto WHERE id_clasificacion = 4";
...
$sql = "SELECT id_moto, marca, modelo, anio, precio FROM moto 
        ...
        WHERE clasificacion_moto.nombre_clasificacion = ? AND moto.id_clasificacion = 4";
    ...
    <div class="container">
        ...
        <hr>
            ...
            <ul class="category-list">
                ...
                <li><a href="cuatrimoto.php">Cuatrimoto</a></li>
            </ul>
                    ...
                    <div class="scroll-container">
                        <?php foreach ($motos as $moto): ?>
                            <div class="product-card">
                                ...
                                <?php else: ?>
                                        <img src="default1.jpeg" alt="Imagen no disponible" class="product-image" width="100" height="100">
                                <?php endif; ?>
