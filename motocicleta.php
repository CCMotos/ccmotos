...
$marcas = [];
$sqlMarcas = "SELECT DISTINCT marca FROM moto WHERE id_clasificacion = 2";
...
// Consultar motocicletas en la categoría "Motocicleta" y por marca si se seleccionó una
...
$sql = "SELECT id_moto, marca, modelo, anio, precio FROM moto 
        ...
        WHERE clasificacion_moto.nombre_clasificacion = ? AND moto.id_clasificacion = 2";
